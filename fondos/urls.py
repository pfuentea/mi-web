...
urlpatterns = [
    ...
    path('cuotas/pago/<int:pago_id>/abono/', views.agregar_abono, name='agregar_abono'),
    path('cuotas/abono/<int:abono_id>/editar/', views.editar_abono, name='editar_abono'),
    path('cuotas/abono/<int:abono_id>/eliminar/', views.eliminar_abono, name='eliminar_abono'),
